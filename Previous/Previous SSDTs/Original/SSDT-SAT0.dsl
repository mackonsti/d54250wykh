 ...
 *
 *     - Added compatibility ID to (SAT0) for improved vanilla detection
 */

DefinitionBlock ("SSDT-SAT0.aml", "SSDT", 1, "Clover", "DevInj", 0x00003000)
{
    Method (\_SB.PCI0.SAT0._DSM, 4, NotSerialized)  // Intel Corporation 8 Series SATA Controller [AHCI mode] [8086:9c03]
    {
        If (LEqual (Arg2, Zero))
        {
