...
DefinitionBlock ("SSDT.aml", "SSDT", 1, "APPLE ", "CpuPm", 0x00018500)
{
    ...
    Scope (\_PR_.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version....: 18.5 / Mac OS X 10.10.5 (14F1808)", Debug)
        ...
        Name (APLF, Zero)  // Apple Lowest Frequency
        Name (APSN, 0x0D)  // Number of Turbo States
        Name (APSS, Package (0x13)  // CPU has 19 P-States (1300-2600MHz)
        {
            ...
            Package (0x06) { 0x05DC, 0x003A98, 0x0A, 0x0A, 0x0F00, 0x0F00 },
            Package (0x06) { 0x0578, 0x003A98, 0x0A, 0x0A, 0x0E00, 0x0E00 },
            /* High Frequency Modes (non-turbo) */
            Package (0x06) { 0x0514, 0x003A98, 0x0A, 0x0A, 0x0D00, 0x0D00 },
            Package (0x06) { 0x04B0, 0x003579, 0x0A, 0x0A, 0x0C00, 0x0C00 },
            Package (0x06) { 0x044C, 0x003075, 0x0A, 0x0A, 0x0B00, 0x0B00 },
            Package (0x06) { 0x03E8, 0x002B8C, 0x0A, 0x0A, 0x0A00, 0x0A00 },
            Package (0x06) { 0x0384, 0x0026BD, 0x0A, 0x0A, 0x0900, 0x0900 },
            /* Low Frequency Mode */
            Package (0x06) { 0x0320, 0x002209, 0x0A, 0x0A, 0x0800, 0x0800 }
        })
