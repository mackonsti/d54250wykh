 ...
 *
 *     - Original device (EHC1) renamed (EH01) via Clover DSDT patching
 *     - Introduced minor code fixes to (EH01) and (XHC) for compatibility
 */

DefinitionBlock ("SSDT-USB.aml", "SSDT", 1, "Clover", "DevInj", 0x00003000)
{
    Method (\_SB.PCI0.EH01._DSM, 4, NotSerialized)  // Intel Corporation 8 Series USB EHCI Controller [8086:9c26]
    {
        If (LEqual (Arg2, Zero))
        {
