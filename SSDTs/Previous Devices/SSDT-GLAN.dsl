 ...
 *
 *     - Introduced minor code fixes to (GLAN) for improved device detection
 */

DefinitionBlock ("SSDT-GLAN.aml", "SSDT", 1, "Clover", "DevInj", 0x00003000)
{
    Method (\_SB.PCI0.GLAN._DSM, 4, NotSerialized)  // Intel Corporation Ethernet Controller I218-V [8086:1559]
    {
        If (LEqual (Arg2, Zero))
        {
